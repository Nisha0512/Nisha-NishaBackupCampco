    ...
    <div class="width-container-qube  fade-header-qube">
         <div  class="navigation_MyProfile">
          <%--      <ul class="tabs wc-tabs">--%>
            <ul>
                  <li> <a href="UpdateMyProfile.aspx" class="updprflactive">Profile</a> </li>
   ...
   <%--     <h1 class="entry-title-qube-ezio">My Profile</h1>--%>
    ...
    <div class="width-container-qube">
     ...
     <script type="text/javascript">
         ...
         {
            jQuary(".navigation_MyProfile > li").click(function ()
            {
               jQuary(".navigation_MyProfile > li").removeClass('current');
               jQuary(this).addClass('active_myprofile');
                jQuery(this).toggleClass('active_myprofile');
            });
        });
