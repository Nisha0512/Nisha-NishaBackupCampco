...
<%@ Page Title="" Language="C#" MasterPageFile="~/Common/CampcoCommon.Master" AutoEventWireup="true" CodeBehind="HumveeAboutus.aspx.cs" Inherits="Campco.Common.WebForm5" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="width-container-qube  fade-header-qube">
      <div class="page-tite-left-qube">
        <h1 class="entry-title-qube-ezio">About Us</h1>
      </div>
              ...
              <div class="vc_column-inner ">
                <div class="wpb_wrapper">
                  <div class="wpb_text_column ">
                    <div class="wpb_wrapper">
                      <h4>About Humvee</h4>
                      <p style="text-align:justify">CampCo is an established wholesale stocking master distributor. 2015 marks our 25th year of service to retailers all over the world. We are the official worldwide licensee for Smith & Wesson Watches and Pepper Spray, Humvee-gear, and UZI products. Located in Los Angeles, we are proud to offer same day shipping and a low $300 initial minimum order in exlcusive CampCo products ($500 + shipping charges for international customers), and a $50 reorder beyond that. Our friendly and courteous staff are ready and willing to answer any of your questions. We pride ourselves in having the latest and most innovative products in the industry.</p>
            ...
            <div class="wpb_column vc_column_container vc_col-sm-6">
              <div class="vc_column-inner ">
                <div class="wpb_wrapper">
                  <div class="wpb_text_column  ">
                    <div class="wpb_wrapper">
                     <img src="assets/images/about-us-humvee.jpg">
                    </div>
                  </div>                 
                </div>
              </div>
