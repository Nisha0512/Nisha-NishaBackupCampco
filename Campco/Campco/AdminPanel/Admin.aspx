<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/CampcoAdmin.Master" AutoEventWireup="true" CodeBehind="Admin.aspx.cs" Inherits="Campco.AdminPanel.Admin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <!-- #content-qube -->
    <%--<script type='text/javascript' src="~/common/assets/js/paging.js"></script>--%>
